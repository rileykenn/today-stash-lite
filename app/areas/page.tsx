...
// ── Simple helper to generate stable colors from strings for placeholders ──
        ...
        <div className="mx-auto max-w-5xl px-4 py-8">
          <header className="mb-12 text-center">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">
              Areas We&apos;re{" "}
              <span className="text-emerald-400">Promoting</span>
            </h1>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed mb-8">
              ...
              Subscribe to an area to unlock exclusive deals from your favorite
              local businesses.
            </p>
            ...
            <div className="inline-block bg-white/5 rounded-2xl p-6 border border-white/10">
              <p className="text-xl text-white font-medium mb-1">
                ...
                <a
                  href="/waitlist"
                  className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-500/30 underline-offset-4 transition-all"
                >
                  Join the waitlist
                </a>
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {townsList.map((town: any) => (
              <Link
                href={
                  town.slug === "sussex-inlet"
                    ? "/invitations/sussex-inlet"
                    : `/areas/${town.slug}`
                }
                key={town.id}
