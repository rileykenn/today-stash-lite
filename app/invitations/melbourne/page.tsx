...
export default function MelbourneBetaPage() {
  ...
  const handleConsumerClick = () => {
    if (loggedIn) {
      ...
      // NOTE: "melbourne" is just a placeholder slug for now
      router.push("/signup?role=consumer&area=melbourne");
    }
  };
      ...
      <section className="relative mx-auto max-w-5xl px-4 pt-12 pb-16 sm:pt-16 sm:pb-20">
        ...
        <div className="flex flex-col gap-3 mb-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="text-[11px] sm:text-xs text-white/55 sm:max-w-xs sm:text-right">
            ...
            Melbourne until we hit our internal cap.
          </p>
        </div>
        ...
        <div className="space-y-4 max-w-3xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight">
            ...
            <span className="text-emerald-400">Melbourne</span>.
          </h1>
          <p className="text-sm sm:text-base text-white/70">
            ...
            And we want{" "}
            <span className="font-semibold">Melbourne</span> to be one of our
            first launch cities.
          </p>
          <p className="text-sm sm:text-base text-white/70">
            For a strictly limited beta period,{" "}
            <span className="font-semibold text-emerald-300">
              consumers and businesses in Melbourne pay $0
            </span>{" "}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4 sm:p-5 shadow-[0_18px_40px_rgba(0,0,0,0.7)]">
                ...
                <ul className="space-y-1.5 text-xs sm:text-[13px] text-white/80">
                  ...
                  <li>• First look at exclusive offers in Melbourne</li>
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl bg-[#0B1215] ring-1 ring-white/10 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
              ...
              <ol className="space-y-3 text-sm text-white/80">
                ...
                <li>
                  ...
                  We&apos;ll invite you into the beta with early Melbourne
            ...
            <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4">
              ...
              <p className="text-xs sm:text-[13px] text-white/75">
                Melbourne&apos;s neighbourhoods run on loyal regulars and local
                favourites — from laneway cafés and bars to gyms, salons,
                recreation and more. Today&apos;s Stash is built to drive real
                foot traffic and repeat visits to{" "}
                <span className="font-semibold">local venues</span> while giving
                everyday people more reasons to explore their city.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-[#020712] ring-1 ring-white/10 p-4 flex flex-col gap-2">
              <p className="text-[11px] text-white/60">
                ...
                Outside Melbourne, the first 100 consumers to join the waiting
                list for their town will receive{" "}
        ...
        <div className="mt-12 border-t border-white/10 pt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
          <span className="text-xs text-white/60">
            Ready to be part of the founding Melbourne community?
          </span>
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <button
              type="button"
