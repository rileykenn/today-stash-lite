-- Add daily per-user redemption check with midnight reset
-- This migration updates the redeem_offer_with_pin function to check if a user
-- has already redeemed a deal today (since midnight Sydney time)
